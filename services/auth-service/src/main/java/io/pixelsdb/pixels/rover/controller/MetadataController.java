...
public class MetadataController
{
    ...
    public ApiResponse<GetSchemasResponse> getSchemas(@RequestBody GetSchemasRequest request)
    {
        ...
        {
            log.error("Upstream metadata server returned error for getSchemas: {}", e.getMessage());
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, "Upstream metadata service error: " + e.getStatusCode());
        }
        catch (WebClientRequestException e)
        {
            log.error("Failed to connect to upstream metadata server for getSchemas: {}", e.getMessage());
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, "Upstream metadata service unavailable");
        }
        catch (Exception e)
        {
            log.error("Unexpected error in getSchemas", e);
    ...
    public ApiResponse<GetTablesResponse> getTables(@RequestBody GetTablesRequest request)
    {
        ...
        {
            log.error("Upstream metadata server returned error for getTables: {}", e.getMessage());
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, "Upstream metadata service error: " + e.getStatusCode());
        }
        catch (WebClientRequestException e)
        {
            log.error("Failed to connect to upstream metadata server for getTables: {}", e.getMessage());
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, "Upstream metadata service unavailable");
        }
        catch (Exception e)
        {
            log.error("Unexpected error in getTables", e);
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, e.getMessage());
        }
    }
    ...
    public ApiResponse<GetColumnsResponse> getColumns(@RequestBody GetColumnsRequest request)
    {
        ...
        {
            log.error("Upstream metadata server returned error for getColumns: {}", e.getMessage());
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, "Upstream metadata service error: " + e.getStatusCode());
        }
        catch (WebClientRequestException e)
        {
            log.error("Failed to connect to upstream metadata server for getColumns: {}", e.getMessage());
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, "Upstream metadata service unavailable");
        }
        catch (Exception e)
        {
            log.error("Unexpected error in getColumns", e);
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, e.getMessage());
        }
    }
    ...
    public ApiResponse<GetViewsResponse> getViews(@RequestBody GetViewsRequest request)
    {
        ...
        {
            log.error("Upstream metadata server returned error for getViews: {}", e.getMessage());
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, "Upstream metadata service error: " + e.getStatusCode());
        }
        catch (WebClientRequestException e)
        {
            log.error("Failed to connect to upstream metadata server for getViews: {}", e.getMessage());
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, "Upstream metadata service unavailable");
        }
        catch (Exception e)
        {
            log.error("Unexpected error in getViews", e);
            return ApiResponse.error(ErrorCode.INTERNAL_ERROR, e.getMessage());
        }
    }
}
