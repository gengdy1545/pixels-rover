...
public class GlobalExceptionHandler
{
    ...
    public ApiResponse<?> handleAccessDeniedException(AccessDeniedException e, HttpServletRequest request)
    {
        ...
        return ApiResponse.error(ErrorCode.ACCESS_DENIED, "No permission, please contact the administrator");
    }
    ...
    public ApiResponse<?> handleCaptcha(CaptchaException e, HttpServletRequest request)
    {
        ...
        return ApiResponse.error(ErrorCode.INVALID_ARGUMENT, e.getMessage());
    }
    ...
    {
        return ApiResponse.error(ErrorCode.ACCESS_DENIED, "Demo mode, operation is not permitted");
    }
