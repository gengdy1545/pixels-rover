...
# ---------------------------------------------------------------------------
# Cookie-based auth for semantic endpoints
# ---------------------------------------------------------------------------


class TestSemanticCookieAuth:
    """Verify cookie-based authentication works for semantic endpoints."""

    async def test_metrics_via_cookie(self, async_client):
        token = make_access_token()
        resp = await async_client.get(
            "/api/v1/semantic/metrics",
    ...
    async def test_dimensions_via_cookie(self, async_client):
        token = make_access_token()
        resp = await async_client.get(
            "/api/v1/semantic/dimensions",
            cookies={"access_token": token},
    ...
    async def test_synonyms_via_cookie(self, async_client):
        token = make_access_token()
        resp = await async_client.get(
            "/api/v1/semantic/synonyms",
            cookies={"access_token": token},
